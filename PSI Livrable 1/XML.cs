    ...
    public class XML
    {
        ...
        public static void InsertCuisiniers(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Cuisinier"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Cuisinier VALUES (@id, @nom, @prenom, @adresse, @cp, @ville, @tel, @email, @metro)";
        ...
        public static void InsertParticuliers(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Particulier"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Particulier VALUES (@id, @nom, @prenom, @adresse, @cp, @tel, @email, @metro)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertEntreprises(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Entreprise"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Entreprise VALUES (@id, @nom, @contact, @adresse, @cp, @tel, @email, @metro)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertCommandes(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Commande"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Commande (IDCommande, DateCommande, AdresseLivraison, Satisfaction, NumeroCuisinier, NumeroParticulier, NumeroEntreprise) VALUES (@id, @date, @adresse, @satisfaction, @cuisinier, @particulier, @entreprise)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertPlats(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Plat"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Plat VALUES (@id, @nom, @prix, @quantite, @type, @dateFab, @datePer, @regime, @nat, @cuisinier)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertIngredients(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Ingredient"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Ingredient (IdIngredient, Nom, Quantite) VALUES (@id, @nom, @quantite)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertEstCompose(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("EstCompose"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO EstCompose VALUES (@plat, @ingredient)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        public static void InsertContient(string filePath)
        {
            ...
            foreach (XElement element in doc.Root.Elements("Contient"))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT IGNORE INTO Contient VALUES (@commande, @plat)";
                    MySqlCommand cmd = new MySqlCommand(query, conn);
